...
-- Records of machine
-- ----------------------------
INSERT INTO `machine` VALUES ('1', '一号机', '0', '2', '0', '2019-05-09 19:57:57', '2019-05-24 13:21:13');
INSERT INTO `machine` VALUES ('2', '二号机', '1', '2', '0', '2019-05-09 19:57:57', '2019-05-12 00:23:33');
INSERT INTO `machine` VALUES ('3', '三号机', '1', '2', '0', '2019-05-12 21:37:20', '2019-05-18 11:45:44');
...
INSERT INTO `material` VALUES ('7', '油菜', '2.00', '0', '2019-05-18 10:44:19', '2019-05-18 10:44:19', '1000.00');
...
CREATE TABLE `product` (
  ...
  `product_material_weight` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '生产原料重量',
  `product_out_name` varchar(255) NOT NULL COMMENT '产出物名称',
  `product_out_weight` decimal(10,0) unsigned NOT NULL DEFAULT '0' COMMENT '产出物重量',
  `is_delete` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '逻辑删除，0-存在，1-已被删除',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('1', '2', '1', '1', '50.00', '面粉', '25', '0', '2019-05-16 09:05:24', '2019-05-21 16:17:37');
INSERT INTO `product` VALUES ('2', '4', '1', '6', '12.00', '玉米油', '55', '0', '2019-05-21 16:51:04', '2019-05-24 13:44:50');
...
-- Records of repair
-- ----------------------------
INSERT INTO `repair` VALUES ('1', '1', '1', '50.00', '0', '2019-05-16 16:12:21', '2019-05-16 22:29:05', '开关坏了');
INSERT INTO `repair` VALUES ('2', '1', '1', '55.00', '0', '2019-05-18 11:21:14', '2019-05-22 21:57:29', '传送带坏了');
INSERT INTO `repair` VALUES ('3', '2', '1', '60.00', '0', '2019-05-18 11:49:45', '2019-05-18 12:57:45', '传送带坏了');
INSERT INTO `repair` VALUES ('4', '1', '1', '120.00', '0', '2019-05-21 16:13:57', '2019-05-21 16:14:24', '开关坏了');
...
INSERT INTO `user` VALUES ('6', '是傻傻', '123123', '1', '0', '2019-05-18 16:34:24', '2019-05-18 16:34:24');
